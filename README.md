...
To get around this issue, download this file [ibm-cloud-elasticsearch.yaml](https://github.com/IBM/elasticsearch-recommender-watson-studio/blob/main/yaml/ibm-cloud-elasticsearch.yaml)
...
For Watson Studio we will use a [modified version](https://github.com/IBM/elasticsearch-recommender-watson-studio/blob/main/notebooks/Elasticsearch%20Collab%20Filtering%20with%20Spark%20Template.ipynb) of the notebook with specific code and instructions for running on IBM Cloud.
